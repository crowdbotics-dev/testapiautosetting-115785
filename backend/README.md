...
## Project Structure
    ...
    ├── testapiautosetting_115785  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_115785`
...
2. Clone this repo and `cd testapiautosetting_115785`
